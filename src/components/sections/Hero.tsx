...
import { Server, ArrowRight, Terminal, Shield, Network, Code, Monitor, Database, Cpu, Wifi, Lock, Zap, Brain, Rocket, Star, CloudLightning as Lightning, GraduationCap } from 'lucide-react';
