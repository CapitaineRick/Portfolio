          ...
          {filteredArticles.length === 0 ? (
            ...
            <div className="space-y-12">
              {filteredArticles.map((item, index) => (
                ...
                >
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500 to-purple-500 rounded-3xl blur opacity-30 group-hover:opacity-75 transition duration-500"></div>
                  <div className="relative bg-gray-800/90 backdrop-blur-sm rounded-3xl overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                      ...
                      {/* Content Section - Plus grande avec focus sur la description */}
                      <div className="lg:col-span-8 p-8 flex flex-col">
                        {/* Titre plus discret */}
                        <h3 className="text-lg font-semibold text-gray-300 mb-6 leading-tight">
                          {item.title}
                        </h3>
                        ...
                        <div className="flex-1 mb-8">
                          <div className="relative">
                            <div className="text-base text-white leading-relaxed bg-gray-900/30 p-6 rounded-2xl border border-gray-700/30">
                              <pre className="whitespace-pre-wrap font-sans text-gray-100">
                                {item.description}
                              </pre>
                            </div>
                            
                            {/* Gradient overlay pour l'effet de lecture */}
                            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-gray-900/20 pointer-events-none rounded-2xl"></div>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center pt-6 border-t border-gray-700/30">
                          <div className="flex items-center gap-2 text-sm text-gray-400">
                            ...
                            <span>Lecture approfondie recommandée</span>
                          </div>
                          ...
                          <a
                            ...
                            className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-purple-500 
                                     text-white font-medium transition-all duration-300
                                     hover:opacity-90 hover:scale-105 group/btn shadow-lg"
                          >
                            <span>Source complète</span>
