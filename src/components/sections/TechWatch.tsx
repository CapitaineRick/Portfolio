          ...
          <div className="relative group">
            ...
            <div className="relative bg-gray-800 p-6 rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-white">Surveillance Active</h3>
                  <p className="text-sm text-gray-400">Veille quotidienne</p>
                </div>
              </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gray-800 p-6 rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-white">Sources Variées</h3>
                  <p className="text-sm text-gray-400">Multi-sources</p>
                </div>
              </div>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-sm text-gray-300">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gray-800 p-6 rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-white">Analyse Approfondie</h3>
                  <p className="text-sm text-gray-400">Synthèse régulière</p>
                </div>
              </div>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-sm text-gray-300">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-semibold text-white">Recherche</h3>
                  </div>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-2 rounded-xl bg-gray-700 
