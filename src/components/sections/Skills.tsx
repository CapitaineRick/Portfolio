...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-20 bg-gray-900 relative" itemScope itemType="https://schema.org/ItemList">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-purple-500" itemProp="name">
            ...
            >
              <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-gray-600 transition-colors duration-300">
                ...
                <div className="flex items-center gap-6 mb-10">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-2" itemProp="name">
                      {category.name}
                    </h3>
                  </div>
                </div>
