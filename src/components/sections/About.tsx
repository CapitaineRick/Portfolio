            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
              ...
              <div className="md:w-1/3">
                <div className="relative group">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full blur opacity-50 group-hover:opacity-75 transition duration-1000"></div>
                  <div className="relative w-48 h-48 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center transform group-hover:scale-105 transition duration-500">
              ...
              <div className="md:w-2/3">
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <div className={`transition-all duration-500 ${showPastEducation ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
                        {/* BTS SNIR - Non validé */}
                        <div className="group relative mt-6">
                          <div className="absolute -inset-0.5 bg-gradient-to-r from-red-500 to-red-600 rounded-xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
                          <div className="relative bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200/50 dark:border-gray-700/50 transform group-hover:scale-[1.01] transition duration-500">
                            <div className="flex items-center mb-4">
                              <img 
                ...
                <div className="mb-8">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-2xl font-semibold">Certifications et Formations</h3>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <div className={`transition-all duration-500 ${showCertifications ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
