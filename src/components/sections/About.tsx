...
import { educationData } from 'src/components/data/educationData.ts';
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-800 rounded-2xl p-6">
                  ...
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold mb-2 text-white">Fernandes Sébastien</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    <div className="bg-gray-700/50 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-orange-500">{ongoingEducation.length + completedEducation.length}</div>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-800 rounded-2xl p-6">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-white">Qui suis-je ?</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                      <div className="bg-gradient-to-br from-gray-700/50 to-gray-700/30 p-6 rounded-xl">
                        <h4 className="font-semibold text-lg mb-4 text-orange-400">Points forts</h4>
                      ...
                      <div className="bg-gradient-to-br from-gray-700/50 to-gray-700/30 p-6 rounded-xl">
                        <h4 className="font-semibold text-lg mb-4 text-purple-400">Centres d'intérêt</h4>
                        <ul className="space-y-3">
                          <li className="flex items-center gap-3">
                          ...
                          <li className="flex items-center gap-3">
                            <div className="w-2 h-2 rounded-full bg-purple-500"></div>
                            <span className="text-gray-300">Veille technologique</span>
                          </li>
                          <li className="flex items-center gap-3">
                            <div className="w-2 h-2 rounded-full bg-purple-500"></div>
                            <span className="text-gray-300">Administration système</span>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gray-800 rounded-2xl p-6">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-white">Parcours Académique</h3>
                  </div>
